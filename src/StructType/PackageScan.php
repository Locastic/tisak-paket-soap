...
/**
 * This class stands for PackageScan StructType
 * @subpackage Structs
 */
class PackageScan extends AbstractStructBase
{
    /**
     * The ScanTime
    ...
    public $Comment;
    /**
     * Constructor method for PackageScan
     * @uses PackageScan::setScanTime()
     * @uses PackageScan::setScan()
     * @uses PackageScan::setScanDescription()
     * @uses PackageScan::setCenter()
     * @uses PackageScan::setComment()
     ...
     * Set ScanTime value
     * @param string $scanTime
     * @return \Locastic\PaketTisakSoap\StructType\PackageScan
     */
